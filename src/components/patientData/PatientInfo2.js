...
export const timeline1 = [
  {
    ...
    desc: "After 3rd chemotherapy, patient survived.",
  },
  {
    icon: workIcon,
    date: "2010 - 2011",
    ...
    subtitle:
      "Status : patient shows signs of recovery and body is responding well to chemotherapy",
    desc: "chemotherapy exact details:",
  },
  {
    icon: workIcon,
    date: "2008 - 2010",
    title: "Second Diagnosis",
    subtitle: "Status : chemotherapy in Progress",
    desc: "Patient on low diet and chemotherapy in progress",
  },
  {
    icon: workIcon,
    date: "2006 - 2008",
